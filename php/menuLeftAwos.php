<div class="border-2sw w-18">
    ...
    <!-- Metar -->
    <div class="w-90 m-5 mt-10">
        <div class="d-flex">
            <button class="button bg-blue">METAR</button>
            <div class="text-center border-white text-white fw-bold ml-5 w-32">18" 10""</div>
            <div class="bg-blue ml-5 w-13 br-20p"></div>
        </div>
    </div>
    <!-- Speci -->
    <div class="w-90 m-5 mt-10">
    ...
    <div class="w-90 m-5 mt-10">
        <div class="d-flex">
            ...
            <div class="text-center border-white text-white fw-bold ml-5 w-32">AUTO</div>
            <div class="bg-blue text-center text-white fw-bold ml-5 w-13 br-20p">A</div>
        </div>
    </div>
    <!-- Syrep -->
    <div class="w-90 m-5 mt-10">
